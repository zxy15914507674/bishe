...
{
    public partial class FrmAddShortAnswerQuestion : Form
    {
        ExpsTableManager expsManager = new ExpsTableManager();
        public FrmAddShortAnswerQuestion()
        {
            InitializeComponent();
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            string keyword = this.txtKeyword.Text.Trim();                   //得分关键词
            ...
            try
            {
                addResult = new ShortAnswerQuestionManager().AddShortAnswerQuestion(shortAnswerQuestion);
            }
            catch (Exception ex)
            {
