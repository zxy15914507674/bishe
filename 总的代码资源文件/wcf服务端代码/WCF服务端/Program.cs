...
namespace WCF服务端
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Uri uri4 = new Uri("http://47.94.102.147:8000/FaceService");
            ...
            ServiceHost host4 = new ServiceHost(typeof(FaceService), uri4);
            ...
            WSHttpBinding bind4 = new WSHttpBinding();
            bind4.MaxReceivedMessageSize = 209715200;
        
            bind4.Security.Mode = SecurityMode.None;
            ...
            host4.AddServiceEndpoint(typeof(IFaceContract), bind4, "FaceInterface");
            ...
            //建立元数据行为对象
            ServiceMetadataBehavior behavior4 = new ServiceMetadataBehavior();
            //设置httpgetEnabled属性
            behavior4.HttpGetEnabled = true;
            //把这个服务元数据行为对象添加到宿主ServiceHost对象的行为集合中去
            host4.Description.Behaviors.Add(behavior4);
